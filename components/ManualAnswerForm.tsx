        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-5">
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full px-4 py-3 bg-white/10 border border-white/15 rounded-lg text-white text-sm placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-red-400/60 focus:border-red-400/40 focus:bg-white/15 transition-all"
            ...
            {error && (
              <div className="bg-red-600/15 border border-red-500/30 rounded-lg p-2.5 animate-in slide-in-from-top-2 duration-200">
            ...
            <button
              ...
              className="w-full min-h-[46px] bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 active:scale-[0.98] disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold py-3 px-5 rounded-lg transition-all duration-200 shadow-md disabled:cursor-not-allowed text-sm"
            >
              {isSubmitting ? (
